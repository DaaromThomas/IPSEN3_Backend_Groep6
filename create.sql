...
create table packaging (amountinstock integer not null, is_deleted boolean default false, minamount integer not null, id varchar(255) not null, name varchar(255), packaginggroup varchar(255), stock varchar(255), primary key (id));
